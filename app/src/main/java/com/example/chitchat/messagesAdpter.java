                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                // For demonstration purposes, I'm removing the message from the list
                        ...
                        .setTextColor(context.getResources().getColor(android.R.color.holo_red_dark)); // Change color to red
